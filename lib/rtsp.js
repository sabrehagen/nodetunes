...
RtpServer.prototype.getEncryptionKeys = function(args) {
  const ret = {
    key: this.audioAesKey.toString('hex'),
...
RtpServer.prototype.setEncryptionKeys = function(args) {
  this.audioAesKey = new Buffer(args.key,'hex');
